...
#Compare hydrogen environments. Result should be close to one 
print(np.dot(turbosoap_water[1], turbosoap_water[2]))

#Compare oxygen-hydrogen. 
#The result should be quite small as the hydrogen and oxygen environments are quite different
